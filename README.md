...
* This is my very first machine learning project and Kaggle competition. In this project, I got to practice the end-to-end machine learning workflow as well as experiment with some basic data analysis.

## What I Learned

* How to set up a proper working environment.

* How to carry out basic EDA.

* How to set up a data pipeline.

* How to get started with a baseline model.

* How to apply linear regression to improve model performance.
